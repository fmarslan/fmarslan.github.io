---
layout: post
title: "JSF treeview component preparation"
date: 2015-01-28
description: "A short technical note outlining the basic approach and applicable steps in preparing a JSF treeview component."
categories: JSF
lang: en-US
translation_key: "jsf-treeview-component-hazirlama-de889d68"
permalink: /en/2015/01/28/jsf-treeview-component-preparation.html
---

If one day you need a treeview like me, here are the codes and I will try to help you wherever you get stuck :)

Dependencies: jQuery & Font Awesome

Usage (dtoList elements must be derived from the INode interface)
```html
