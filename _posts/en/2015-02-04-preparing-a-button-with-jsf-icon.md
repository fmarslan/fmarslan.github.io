---
layout: post
title: "Preparing a Button with JSF Icon"
date: 2015-02-04
description: "A short technical note outlining the basic approach and applicable steps for Creating a JSF Icon Button."
categories: JSF
lang: en-US
translation_key: "jsf-ikonlu-buton-hazirlama-f0446cae"
permalink: /en/2015/02/04/preparing-a-button-with-jsf-icon.html
---

If you want to use icons for the submit buttons you use when using the JSF framework, you can prepare your own button as follows (I could not clean the code much this time, you can ask if there is something unclear) the icons are taken from the fontawesome library.
