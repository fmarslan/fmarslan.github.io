---
layout: post
title: "Input File Upload Component for JSF 1.2"
date: 2014-10-26
description: "A short technical note outlining the basic approach and applicable steps on Input File Upload Component for JSF 1.2."
categories: JSF
lang: en-US
translation_key: "jsf-12-icin-input-file-upload-componenti-9d5bed8e"
permalink: /en/2014/10/26/input-file-upload-component-for-jsf-1-2.html
---

I don't know if anyone uses it, but there is no file upload in JSF 1.2. To tolerate this, I re-wrote an inputFile component so that someone else who needs it doesn't have to deal with it.
...
You can use it as inputFile with the tag you define in the xhtml file.
