---
layout: post
title: "checkpoint ssl/vpn connection in linux operating system"
date: 2017-07-21
description: "A short technical note summarizing the basic approach and applicable steps for Checkpoint SSL/VPN connection in Linux operating system."
categories: Linux
lang: en-US
translation_key: "linux-isletim-sisteminde-checkpoint-ssl-vpn-baglantisi-5492a5cc"
permalink: /en/2017/07/21/checkpoint-ssl-vpn-connection-in-linux-operating-system.html
---

Step 1: Installation of the following packages and additionally installation of updated Oracle JRE [(Source)](https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=sk65210)
...
<tr><td>Ubuntu<br>&nbsp;14.04<br>&nbsp;16.04<br>&nbsp;16.10<br>&nbsp;17.04</td><td>libpam0g:i386<br>libx11-6:i386<br>libst dc++6:i386<br>libstdc++5:i386</td><td>libpam0g:i386<br>libx11-6:i386<br>libstdc++6:i386<br>libstdc++5:i386<br>libnss3-tools (certutil)&nbsp;</td><td>Apt-get</td></tr>
...
<tr><td>Fedora 16/18</span></td><td><ol><li>xterm.i686</li><li>libstdc++.so.5</li></ol></td><td><ol><li>xterm.x86_64 (with libXaw.86_64 dependency)</span></li><li>elf_utils-libelf.i686</span></li><li>libX11.i686</li><li>libaudit.so.1</li><li>libc rack.so.2</li><li>libdb-5.3.so</li><li>libselinux.so.1</li><li>libpam.so.0</li><li>libstdc++.so.5</li></ol>For Mobile Access Portal Agent: (also)<br><ol><li>10. libXext.i686</li><li>libXrender.i686</li><li>libXtst.i686</li><li>libXi.i686</li></ol></td><td>dnf install &lt;lib_name&gt;&nbsp;</td></tr>
...
Step 3: Connection can be made via Linux terminal as follows. [(Source)](https://sc1.checkpoint.com/documents/R77/CP_R77_VPN_AdminGuide/html_frameset.htm?topic=documents/R77/CP_R77_VPN_AdminGuide/14702&anchor=o14729)

Note: If you get an authentication error, you can try different versions of snx as described [here](https://forum.porteus.org/viewtopic.php?t=6510)
[(Source 2)](https://www.fc.up.pt/ci/servicos/acesso/vpn/vpn-cp-linux.html?&item=495)
